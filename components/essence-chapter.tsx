  ...
  return <section id="manifesto" className="essence-editorial" ref={root} aria-labelledby="essence-title">
    <div className="essence-stage">
      ...
      <svg className="essence-thread essence-thread-desktop" viewBox="0 0 1440 740" fill="none" aria-hidden="true">
        <defs><radialGradient id={`${uid}-pearl`} cx="30%" cy="25%"><stop stopColor="#fff7e6"/><stop offset=".5" stopColor="#bda36e"/><stop offset="1" stopColor="#8d7548"/></radialGradient></defs>
      ...
      <svg className="essence-thread essence-thread-mobile" viewBox="0 0 400 900" fill="none" aria-hidden="true">
        <defs><radialGradient id={`${uid}-pearl-mobile`} cx="30%" cy="25%"><stop stopColor="#fff7e6"/><stop offset=".5" stopColor="#bda36e"/><stop offset="1" stopColor="#8d7548"/></radialGradient></defs>
      ...
      <figure className="essence-smile" data-essence-motion="photo">
        <Image src="/images/luiza-experience.webp" alt="Dra. Luiza Teixeira sorrindo em seu consultório" fill sizes="(max-width:700px) 88vw, 45vw"/>
      </figure>
      ...
      <div className="essence-editorial-copy">
        ...
        <p className="essence-editorial-description" data-essence-motion="fade" data-delay="350">Seu rosto carrega a sua história. O cuidado começa por entender seus traços, sua expressão e o que faz sentido para você.</p>
      ...
      <p className="essence-margin-note">BELEZA REAL<br/>HISTÓRIAS ÚNICAS<span aria-hidden="true"/></p>
    </div>
