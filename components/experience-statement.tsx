...
function ImageSeal({ id }: { id: string }) {
  ...
  return <svg className={styles.seal} viewBox="0 0 126 126" aria-hidden="true" focusable="false">
    ...
    <text className={styles.sealMark} x="63" y="74" textAnchor="middle">lt.</text>
  </svg>;
}
  ...
  return <section ref={root} className={styles.root} aria-labelledby="experience-statement-title">
    ...
    <figure className={styles.photo} data-experience-motion="photo">
      <Image
        ...
        alt="Dra. Luiza Teixeira em seu consultório"
        fill
      ...
      <p className={styles.photoCopy} data-experience-motion="photo-copy">CUIDADO<br />QUE RESPEITA<br />QUEM VOCÊ É.<span aria-hidden="true" /></p>
      <ImageSeal id={uid} />
    </figure>

    <div className={styles.quote} data-experience-motion="quote">
      <span className={styles.quoteMark} aria-hidden="true">lt.</span>
      <div>
        <p>Mais do que estética,<br />é sobre se sentir bem com quem você é.</p>
        <footer><span aria-hidden="true" /><cite>NOSSO OLHAR</cite></footer>
      </div>
    </div>
